...
//Find the Rotation Count in Rotated Sorted testpakg.array
public class CountRotation {
    ...
    //rotation will be one less than the position of minimum element in an testpakg.array.
    ...
    //find number of rotations / find min/max element in a sorted, rotated testpakg.array using binary search.
    //Complexity: O(Log n)
