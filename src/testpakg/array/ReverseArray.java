...
public class ReverseArray {
    public static void main(String args[]){
        ...
        System.out.println("============================== Reverse testpakg.array without recursion ===================");
        reverseArray.reverseUsingSwap(arr);
        reverseArray.printArray(arr);
        System.out.println("\n============================== Reverse testpakg.array with recursion ===================");
        reverseArray.reverseUsingRecursion(arr,0,arr.length-1 );
        reverseArray.printArray(arr);
    }

    //reverse testpakg.array normally, without recursion
    //Complexity: O(n)
    ...
    //reverse testpakg.array using recursion
    //Complexity: O(n)
