...
The sum of elements in the i-th column(0-indexed) is colsum[i], where colsum is given as an integer testpakg.array with length n.
Your task is to reconstruct the matrix with upper, lower and colsum.

Return it as a 2-D integer testpakg.array.

If there are more than one valid solution, any of them will be accepted.

If no valid solution exists, return an empty 2-D testpakg.array
