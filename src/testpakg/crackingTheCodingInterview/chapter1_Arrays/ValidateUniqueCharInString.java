...
/*Is Unique: Implement an testpakg.algorithm to determine if a string has all unique characters. What if you
...
public class ValidateUniqueCharInString {
    ...
    //METHOD-2: use an extra testpakg.array of boolean and set the char to true and compare
